...
<div class="container">
    <div class="row text-center">
		<div class="col" id="artTitle">
			<h2>The Music of the South:</h2>
            <h3>The most popular genre to emerge out of South America</h3>
		</div>
	</div>
</div>
...
<div class="container">
    ...
    <div class="row" id="artRecommend">
        <div class="col">
            <p>Related Articles: <a href="the_roots_of_hop.php">Hip Hop</a>, <a href="the_disco_boom.php">Funk</a>, <a href="r_and_b_evolution.php">R and B</a>, <a href="genre_started_all.php">Blues</a></p>
        </div>
        <div class="col">
            <a class="btn btn-primary" href="https://en.wikipedia.org/wiki/Jazz_music">Further Reading</a>
        </div>
    </div>
    <br><br><br><br>
</div> <!-- container -->

...
<div class="container">
    <div class="row text-center">
		<div class="col" id="artTitle">
            ...
            <h3>A look at the most popular genre of the 60s</h3>
		</div>
	</div>
</div>
...
<div class="container">
    ...
    <div class="row" id="artRecommend">
        <div class="col">
            <p>Related Articles: <a href="rock_explo.php">Rock</a></p>
        </div>
        <div class="col">
            <a class="btn btn-primary" href="https://en.wikipedia.org/wiki/Psychedelic_rock">Further Reading</a>
        </div>
    </div>
    <br><br><br><br>
</div> <!-- container -->

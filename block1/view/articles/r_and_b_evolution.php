...
<div class="container">
    <div class="row text-center">
		<div class="col" id="artTitle">
			<h2>The R and B Evolution:</h2>
            <h3>How the genre evolved into is Pop presence</h3>
		</div>
	</div>
</div>
...
<div class="container">
    ...
    <div class="row" id="artRecommend">
        <div class="col">
            <p>Related Articles: <a href="the_roots_of_hop.php">Hip Hop</a>, <a href="music_of_south.php">Jazz</a>, <a href="the_disco_boom.php">Funk</a>, <a href="genre_started_all.php">Blues</a></p>
        </div>
        <div class="col">
            <a class="btn btn-primary" href="https://en.wikipedia.org/wiki/Rhythm_and_blues">Further Reading</a>
        </div>
        <br><br><br><br>
    </div>
</div> <!-- container -->

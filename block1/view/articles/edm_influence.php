...
<div class="container">
    <div class="row text-center">
		<div class="col" id="artTitle">
			<h2>The Influence of EDM around the World:</h2>
            <h3>How EDM has affected the world's taste in music</h3>
		</div>
	</div>
</div>
...
<div class="container">
    ...
    <div class="row" id="artRecommend">
        <div class="col">
            <a class="btn btn-primary" href="https://en.wikipedia.org/wiki/Electronic_dance_music">Further Reading</a>
        </div>
    </div>
    <br><br><br><br>
</div> <!-- container -->

...
<div class="container">
    <div class="row text-center">
		<div class="col" id="artTitle">
			<h2>The Rock Explosion:</h2>
            <h3>How Rock took the world by storm</h3>
		</div>
	</div>
</div>
...
<div class="container">
    ...
    <div class="row" id="artRecommend">
        <div class="col">
            <p>Related Articles: <a href="sound_of_60s.php">Pyschedelic Rock</a></p>
        </div>
        <div class="col">
            <a class="btn btn-primary" href="https://en.wikipedia.org/wiki/Rock_music">Further Reading</a>
        </div>
    </div>
    <br><br><br><br>
</div> <!-- container -->

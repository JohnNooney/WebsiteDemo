...
<div class="container">
    <div class="row text-center">
		<div class="col" id="artTitle">
			<h2>The Genre that Started it All:</h2>
            <h3>How Blues lead to Rock and many other genres</h3>
		</div>
	</div>
...
<div class="container">
    ...
    <div class="row" id="artRecommend">
        <div class="col">
            <p>Related Articles: <a href="the_roots_of_hop.php">Hip Hop</a>, <a href="music_of_south.php">Jazz</a>, <a href="the_disco_boom.php">Funk</a>, <a href="r_and_b_evolution.php">R and B</a></p>
        </div>
        <div class="col">
            <a class="btn btn-primary" href="https://en.wikipedia.org/wiki/Blues_music">Further Reading</a>
        </div>
    </div>
    <br><br><br><br>
</div> <!-- container -->

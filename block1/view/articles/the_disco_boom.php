...
<div class="container">
    <div class="row text-center">
		<div class="col" id="artTitle">
			<h2>The Disco Boom of America:</h2>
            <h3>How Funk emerged out of Disco</h3>
		</div>
	</div>
</div>
...
<div class="container">
    ...
    <div class="row" id="artRecommend">
        <div class="col">
            <p>Related Articles: <a href="the_roots_of_hop.php">Hip Hop</a>, <a href="music_of_south.php">Jazz</a>, <a href="r_and_b_evolution.php">R and B</a>, <a href="genre_started_all.php">Blues</a></p>
        </div>
        <div class="col">
            <a class="btn btn-primary" href="https://en.wikipedia.org/wiki/Funk">Further Reading</a>
        </div>
    </div>
    <br><br><br><br>
</div> <!-- container -->

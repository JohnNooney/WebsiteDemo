...
<div class="container">
    ...
    <div class="row" id="artRecommend">
        <div class="col">
            <p>Related Articles: <a href="the_disco_boom.php">Funk</a>, <a href="music_of_south.php">Jazz</a>, <a href="r_and_b_evolution.php">R and B</a>, <a href="genre_started_all.php">Blues</a></p>
        </div>
        <div class="col">

...
<div class="container">
    <div class="row text-center">
		<div class="col" id="artTitle">
			<h2>The Roots of Hip Hop:</h2>
            <h3>The inspiration that lead to hip hop's Birth </h3>
		</div>
	</div>
</div>
...
<div class="container">
    ...
    <div class="row" id="artRecommend">
        <div class="col">
            <p>Related Articles: <a href="the_disco_boom.php">Funk</a>, <a href="music_of_south.php">Jazz</a>, <a href="r_and_b_revolution.php">R and B</a>, <a href="genre_started_all.php">Blues</a></p>
        </div>
        <div class="col">
            <a class="btn btn-primary" href="https://en.wikipedia.org/wiki/Hip_hop_music">Further Reading</a>
        </div>
    </div>
    <br><br><br><br>
</div> <!-- container -->

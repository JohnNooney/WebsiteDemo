...
<div class="container">
    <div class="row text-center">
		<div class="col" id="artTitle">
			<h2>The Interesting Fusion of Genres; Afrobeat:</h2>
            <h3>A deepdive of one of the most unique genres of music out of Africa</h3>
		</div>
	</div>
</div>
...
<div class="container">
    ...
    <div class="row" id="artRecommend">
        <div class="col">
            <a class="btn btn-primary" href="https://en.wikipedia.org/wiki/Afrobeat_music">Further Reading</a>
        </div>
    </div>
    <br><br><br><br>
</div> <!-- container -->
